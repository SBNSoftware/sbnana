...
namespace ana {
    ...
    class IcarusRun2DetectorSyst : public ISyst {
    public:
    ...
    protected:
        friend const IcarusRun2DetectorSyst* GetIcarusRun2DetectorSyst(
            const std::string&,
            std::string&,
            const std::string&,
            std::string&,
        ...
        IcarusRun2DetectorSyst(const std::string& dir,
                               std::string& prefix,
    ...
    const IcarusRun2DetectorSyst* GetIcarusRun2DetectorSyst(
